...
@Component({
  ...
  templateUrl: './inteligenciaNegocios.component.html',
  styleUrl: './inteligenciaNegocios.component.css'
})
export class InteligenciaNegociosComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.sidebarService.modulos$
      ...
      .subscribe(() => {
        this.dashboardCards = this.moduleDashboardService.buildDashboardCards('/inteligenciaNegocios');
      });
  }
}
