  ...
  template: `
    <div class="page-container">
      <div class="page-header">
        ...
        <h1 class="page-title"><i class="bi bi-shield-check me-2"></i>Roles</h1>
        <p class="page-subtitle">Administra roles y permisos del sistema</p>
      </div>
      <div class="content-card">
        <div class="card-header">
          <h5 class="mb-0">Lista de Roles</h5>
          <button class="btn btn-primary"><i class="bi bi-plus-circle me-2"></i>Nuevo Rol</button>
        </div>
