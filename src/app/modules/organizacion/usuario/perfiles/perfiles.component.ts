  ...
  template: `
    <div class="page-container">
      <div class="page-header">
        ...
        <h1 class="page-title"><i class="bi bi-person-badge me-2"></i>Perfiles</h1>
        <p class="page-subtitle">Gestiona perfiles de usuario</p>
      </div>
      <div class="content-card">
        <div class="card-header">
          <h5 class="mb-0">Lista de Perfiles</h5>
          <button class="btn btn-primary"><i class="bi bi-plus-circle me-2"></i>Nuevo Perfil</button>
        </div>
