  ...
  template: `
    <div class="page-container">
      <div class="page-header">
        ...
        <h1 class="page-title"><i class="bi bi-grid-3x3-gap me-2"></i>Módulos</h1>
        <p class="page-subtitle">Administra los módulos del sistema</p>
      </div>
      <div class="content-card">
        <div class="card-header">
          <h5 class="mb-0">Lista de Módulos</h5>
          <button class="btn btn-primary"><i class="bi bi-plus-circle me-2"></i>Nuevo Módulo</button>
        </div>
