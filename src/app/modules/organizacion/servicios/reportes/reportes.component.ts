  ...
  template: `
    <div class="page-container">
      <div class="page-header">
        ...
        <h1 class="page-title"><i class="bi bi-file-earmark-bar-graph me-2"></i>Reportes</h1>
        <p class="page-subtitle">Configura y genera reportes del sistema</p>
      </div>
      <div class="content-card">
        <div class="card-header">
          <h5 class="mb-0">Lista de Reportes</h5>
          <button class="btn btn-primary"><i class="bi bi-plus-circle me-2"></i>Nuevo Reporte</button>
        </div>
