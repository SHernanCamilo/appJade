// ============================================================================
// MODELOS DEL MOTOR DE FLUJOS GENÉRICO
// ============================================================================

// Estados de Instancia de Flujo
...
export interface CondicionesRegla {
  ...
  [key: string]: any; // Permite condiciones personalizadas
}
...
// ============================================================================
// REQUESTS PARA ADMINISTRACIÓN DE FLUJOS
// ============================================================================
